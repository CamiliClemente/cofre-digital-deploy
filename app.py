...
# Configurando as mensagens de sistema (logging)
...
@app.route('/database')
def database_info():
    # Buscando os segredos das variáveis de ambiente
    db_host = os.getenv('DB_HOST', 'localhost')
    db_user = os.getenv('DB_USER', 'user')
    db_password = os.getenv('DB_PASSWORD', 'SENHA_NAO_CONFIGURADA')

    # Segurança: Exibe o host e o usuário, mas NUNCA exibe a senha real!
...
def api_key_info():
    ...
    # Mascarando a chave nos logs (Transforma '123456789' em '1234****6789')
